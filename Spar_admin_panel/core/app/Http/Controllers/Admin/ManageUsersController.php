...
class ManageUsersController extends Controller {
    ...
    public function agreementUnverifiedUsers() {
        $pageTitle = 'Agreement Unverified Users';
        $users     = $this->userData('agreementUnverified');
        return view('admin.users.list', compact('pageTitle', 'users'));
    }

    public function agreementVerifiedUsers() {
        $pageTitle = 'Agreement Verified Users';
        $users     = $this->userData('agreementVerified');
        return view('admin.users.list', compact('pageTitle', 'users'));
    }
    ...
    public function kycApprove($id) {
        ...
        // Send agreement document via separate email
        // Commented out temporarily - automatic agreement email disabled
        /*
        $agreementPath = base_path('../assets/agreement/SPAR_Debenture_Subscription_Agreement.-updated.docx');
    ...
    public function update(Request $request, $id) {
        ...
        if ($request->filled('flag_status')) {
            $user->flag_status = (int) $request->flag_status;
        }

        $user->agreement_verified = $request->agreement_verified ? Status::VERIFIED : Status::UNVERIFIED;
