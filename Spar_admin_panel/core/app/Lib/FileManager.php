    ...
    */
	protected function uploadImage(){
        try {
            ...
            // Fallback: If GD/Imagick fails, just move the file without processing
            if (strpos($e->getMessage(), 'GD') !== false || strpos($e->getMessage(), 'driver') !== false) {
                \Log::warning('Image processing library not available, uploading without processing: ' . $e->getMessage());
