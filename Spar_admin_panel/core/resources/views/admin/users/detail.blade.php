                ...
                <div class="card-body">
                    <form action="{{ route('admin.users.update', [$user->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="form-group">
                                    <label>@lang('User Flag')</label>
                                    <select name="flag_status" class="form-control select2">
                                        <option value="{{ \App\Constants\Status::FLAG_GREEN }}" @selected($user->flag_status == \App\Constants\Status::FLAG_GREEN)>@lang('Green')</option>
                                        <option value="{{ \App\Constants\Status::FLAG_YELLOW }}" @selected($user->flag_status == \App\Constants\Status::FLAG_YELLOW)>@lang('Yellow')</option>
                                        <option value="{{ \App\Constants\Status::FLAG_RED }}" @selected($user->flag_status == \App\Constants\Status::FLAG_RED)>@lang('Red')</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-2 col-12">
                                <div class="form-group">
                                    <label>@lang('Agreement') </label>
                                    <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Accepted')" data-off="@lang('Pending')" name="agreement_verified" @if ($user->agreement_verified) checked @endif>
                                </div>
                            </div>
                            <div class="col-xl-2 col-12">
                                <div class="form-group">
