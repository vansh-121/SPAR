                ...
                <tr>
                    ...
                    <td>
                        <div class="action--btns">
                            <a href="{{ route('user.invest.details', encrypt($invest->id)) }}" class="icon-btn bg--base text-white">
                                <i class="fa fa-desktop"></i>
                            </a>
                            @if ($invest->eligibleCapitalBack())
                                <button class="icon-btn bg--base text-white manageCapital" data-id="{{ $invest->id }}">
    ...
    <div class="modal-dialog modal-dialog-centered modal-content-bg">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title text-white" id="ModalLabel">
            ...
            <form action="{{ route('user.invest.capital.manage') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form--label">@lang('Investment Capital')</label>
                        <select name="capital" class="form--control select2" data-minimum-results-for-search="-1">
