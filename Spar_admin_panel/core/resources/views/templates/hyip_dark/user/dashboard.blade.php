...
@section('content')
    ...
    @if ($user->kv == Status::KYC_UNVERIFIED && $user->kyc_rejection_reason)
        <div class="alert alert--base" role="alert">
            <div class="alert__icon d-flex align-items-center"><i class="fas fa-times-circle"></i>
            </div>
        ...
        <div class="col-md-12">
            @if ($user->deposit_wallet <= 0 && $user->interest_wallet <= 0)
                <div class="alert alert--danger" role="alert">
                    <div class="alert__icon d-flex align-items-center"><i class="fas fa-exclamation-triangle"></i></div>
                    <p class="alert__content">
            ...
            @if ($user->deposits->where('status', 1)->count() == 1 && !$user->invests->count())
                <div class="alert alert--success" role="alert">
                    <div class="alert__icon d-flex align-items-center"><i class="fas fa-check"></i>
                    </div>
                    <p class="alert__content">
            ...
            @if ($pendingWithdrawals)
                <div class="alert alert--primary" role="alert">
                    <div class="alert__icon d-flex align-items-center"><i class="fas fa-spinner"></i>
                    </div>
                    <p class="alert__content">
            ...
            @if (!$user->ts)
                <div class="alert alert--warning" role="alert">
                    <div class="alert__icon d-flex align-items-center"><i class="fas fa-user-lock"></i></div>
                    <p class="alert__content">
            ...
            @if ($isHoliday)
                <div class="alert alert--info" role="alert">
                    <div class="alert__icon d-flex align-items-center"><i class="fas fa-toggle-off"></i>
                    </div>
                    <p class="alert__content">
    ...
    <div class="row gy-4 justify-content-center">
        <div class="col-xxl-4 col-xl-4 col-sm-6">
            <div class="dashboard-widget">
                ...
                <div class="dashboard-widget__content">
                    <p class="dashboard-widget__title"> @lang('Deposit Wallet Balance') </p>
                    <h5 class="dashboard-widget__currency"> {{ gs('cur_sym') }}{{ showAmount($user->deposit_wallet, currencyFormat:false) }} </h5>
                    <span class="icon">
        ...
        <div class="col-xxl-4 col-xl-4 col-sm-6">
            <div class="dashboard-widget">
                ...
                <div class="dashboard-widget__content">
                    <p class="dashboard-widget__title"> @lang('Interest Wallet Balance') </p>
                    <h5 class="dashboard-widget__currency"> {{ gs('cur_sym') }}{{ showAmount($user->interest_wallet, currencyFormat:false) }}
                    </h5>
                    <span class="icon">
                        <i class="fa-solid fa-arrow-right"></i>
                    </span>
        ...
        <div class="col-xxl-4 col-xl-4 col-sm-6">
            <div class="dashboard-widget">
                ...
                <div class="dashboard-widget__content">
                    <p class="dashboard-widget__title"> @lang('Total Invest') </p>
                    <h5 class="dashboard-widget__currency"> {{ gs('cur_sym') }}{{ showAmount($totalInvest, currencyFormat:false) }}
                    </h5>
                    <span class="icon">
                        <i class="fa-solid fa-arrow-right"></i>
                    </span>
        ...
        <div class="col-xxl-4 col-xl-4 col-sm-6">
            <div class="dashboard-widget">
                ...
                <div class="dashboard-widget__content">
                    <p class="dashboard-widget__title"> @lang('Total Deposit') </p>
                    <h5 class="dashboard-widget__currency"> {{ gs('cur_sym') }}{{ showAmount($totalDeposit, currencyFormat:false) }}
                    </h5>
                    <span class="icon">
                        <i class="fa-solid fa-arrow-right"></i>
                    </span>
        ...
        <div class="col-xxl-4 col-xl-4 col-sm-6">
            <div class="dashboard-widget">
                ...
                <div class="dashboard-widget__content">
                    <p class="dashboard-widget__title"> @lang('Total Withdraw') </p>
                    <h5 class="dashboard-widget__currency"> {{ gs('cur_sym') }}{{ showAmount($totalWithdraw, currencyFormat:false) }}
                    </h5>
                    <span class="icon">
                        <i class="fa-solid fa-arrow-right"></i>
                    </span>
        ...
        <div class="col-xxl-4 col-xl-4 col-sm-6">
            <div class="dashboard-widget">
                ...
                <div class="dashboard-widget__content">
                    <p class="dashboard-widget__title"> @lang('Referral Earnings') </p>
                    <h5 class="dashboard-widget__currency"> {{ gs('cur_sym') }}{{ showAmount($referralEarnings, currencyFormat:false) }}
                    </h5>
                    <span class="icon">
                        <i class="fa-solid fa-arrow-right"></i>
                    </span>
    ...
    <div class="dashboard-table">
        <h4 class="dashboard-table__title"> @lang('Latest Transaction') </h4>
