...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="text-end">
            <a href="{{ route('user.withdraw.history') }}" class="btn btn--base btn--lg">@lang('Withdrawal History')</a>
        </div>
        <div class="col-xxl-8 col-xl-12">
            <form action="{{ route('user.withdraw.money') }}" method="post" class="withdraw-form">
                @csrf
                <div class="gateway-card custom--card @if ($isHoliday && !gs('holiday_withdraw')) custom--card card countdown-card @endif">
                            ...
                            <div class="col-lg-6">
                                <div class="payment-system-list is-scrollable gateway-option-list">
                                    @foreach ($withdrawMethod as $data)
                                        <label for="{{ titleToKey($data->name) }}" class="payment-item @if ($loop->index > 4) d-none @endif gateway-option form--label">
                                ...
                                <div class="payment-system-list p-3">
                                    <div class="deposit-info">
                                        <div class="deposit-info__title">
                                            <p class="text mb-0 form--label">@lang('Amount')</p>
                                        </div>
                                        <div class="deposit-info__input">
                                            <div class="deposit-info__input-group input-group">
                                                <span class="deposit-info__input-group-text px-3">{{ gs('cur_sym') }}</span>
                                                <input type="text" class="form--control form-control form-two amount" name="amount" placeholder="@lang('00.00')" value="{{ old('amount') }}" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
