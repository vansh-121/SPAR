        ...
        <div class="card-body">
            ...
            <div class="col-md-12 mb-4">
                ...
                <div class="input-group">
                    <input type="text" name="text" class="form-control form--control form-two referralURL"
                        value="{{ route('home') }}?reference={{ auth()->user()->username }}" readonly>
                        <span class="input-group-text input-style copytext copyBoard" id="copyBoard"> <i class="fa fa-copy"></i> </span>
                </div>
            </div>
