                ...
                <div class="card custom--card">
                    <div class="card-header">
                        <div class="thumb__350px">
                            <img src="{{ getImage(fileManager()->promotions()->path.  '/'. @$banner->banner) }}" class="w-100 h-100 promo-image">
                        </div>
                    </div>
                    <div class="referral-form card-body">
                        ...
                        <button  type="button"  data-copytarget="#reflink{{ $banner->id }}" class="btn btn--base justify-content-center w-100 mt-3 copybtn btn-block"><i class="fa fa-copy"></i> &nbsp; @lang('Copy')</button>
                    </div>
                </div>
            </div>
        @endforeach
