                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="key" value="{{$secret}}" class="form-control form--control form-two referralURL" readonly>
                                <button type="button" class="input-group-text input-style copytext input-style" id="copyBoard"> <i class="fa fa-copy"></i> </button>
                            </div>
                        </div>
                    ...
                    <form action="{{route('user.twofactor.disable')}}" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form--control form-two" name="code" required>
                            </div>
