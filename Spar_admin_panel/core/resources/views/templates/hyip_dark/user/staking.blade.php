...
@section('content')
    ...
    <div class="row gy-4 justify-content-center">
        <div class="col-md-12">
            <div class="text-end">
                <button data-bs-toggle="modal" data-bs-target="#stakingModal" class="btn btn--base btn--lg">
                    @lang('Staking Now')
                </button>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-content-bg">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">@lang('Staking Now')</h6>
                ...
                <form action="{{ route('user.staking.save') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select name="duration" class="form--control form-two select2" required>
                        ...
                        <div class="form-group">
                            ...
                            <select name="wallet" class="form--control form-two select2" required data-minimum-results-for-search="-1">
                                <option hidden>@lang('Select One')</option>
                        ...
                        <div class="form-group">
                            <label class="form--label">@lang('Amount') ({{ showAmount(gs('staking_min_amount')) . ' - ' . showAmount(gs('staking_max_amount')) }})</label>
                            <div class="input-group">
                                <input type="number" name="amount" class="form-control form--control form-two" min="0" step="any" autocomplete="off" required>
                                <span class="input-group-text input-style">{{ __(gs('cur_text')) }}</span>
                            </div>
                        </div>
