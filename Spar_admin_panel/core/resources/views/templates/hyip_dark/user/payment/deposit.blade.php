...
@section('content')
    <div class="row justify-content-center">
        <div class="text-end">
            <a href="{{ route('user.deposit.history') }}" class="btn btn--base btn--lg">@lang('Deposit History')</a>
        </div>
                                ...
                                <div class="deposit-info">
                                    ...
                                    <div class="deposit-info__input">
                                        <div class="deposit-info__input-group input-group">
                                            ...
                                            <input type="text" class="form--control form-two form-control amount" name="amount" placeholder="@lang('00.00')" value="{{ old('amount') }}" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <hr>
