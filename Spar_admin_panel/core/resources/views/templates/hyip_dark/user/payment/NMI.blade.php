                    ...
                    <form role="form" class="disableSubmission appPayment" id="payment-form" method="{{ $data->method }}" action="{{ $data->url }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="tel" class="form-control form--control form-two"
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control form--control form-two" name="billing-cc-exp"
                                    value="{{ old('billing-cc-exp') }}" placeholder="e.g. MM/YY" autocomplete="off"
                                    required />
                            </div>
                            <div class="col-md-6 ">
                                <label class="form--label">@lang('CVC Code')</label>
                                <input type="tel" class="form-control form--control form-two" name="billing-cc-cvv"
