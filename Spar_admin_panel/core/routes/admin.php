...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function(){
        ...
        Route::get('agreement-unverified', 'agreementUnverifiedUsers')->name('agreement.unverified');
        Route::get('agreement-verified', 'agreementVerifiedUsers')->name('agreement.verified');
