...
class MyColor {
  // Hedge and Sachs Financials INC Brand Colors
  static const Color primaryColor = Color(0xff55BB3C); // Apple Green
  static const Color secondaryBrandColor = Color(0xff011B3C); // Midnight
  static const Color whiteBrandColor = Color(0xffFFFFFF); // White

  static const Color backgroundColor = Color(0xff011B3C); // Midnight
  static const Color splashBgColor = primaryColor;
  static const Color appBarColor = Color(0xff011B3C); // Midnight

  static const Color fieldEnableBorderColor = primaryColor;
  static const Color fieldDisableBorderColor = Color(0xff1a3a5c);
  static const Color fieldFillColor = Color(0xff02234a);
  static const Color headingTextColor = Color(0xFFFFFFFF);
  static const Color colorBlackFaq = Color(0xff676D75);
  static const Color grayColor3 = Color(0xffF6F6F6);

  /// card color
  static const Color cardPrimaryColor = Color(0xff011B3C);
  static const Color cardSecondaryColor = Color(0xff02234a);
  static const Color cardBorderColor = Color(0xff1a3a5c);
  static const Color cardBgColor = Color(0xff02234a);
  ...
  /// bottom navbar
  static const Color bottomNavBgColor = Color(0xff02234a);
  static const Color borderColor = Color(0xff1a3a5c);
