      ...
      builder: (controller) => controller.isLoading
          ...
          : controller.model.data?.isHoliday == "true"
              ? Column(
                  children: [
                    Text(
                      MyStrings.workingDayMessage.tr,
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: controller.selectedWallet ==
                      ...
                      child: DropdownButton<String>(
                        ...
                        isExpanded: true,
                        underline: Container(
                            height: 0, color: MyColor.getAppbarBgColor()),
                        onChanged: (String? newValue) {
                          if (newValue != null) {
                            controller.changeWallet(newValue);
                          }
                        },
                        items: controller.walletList.map((String wallet) {
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius:
                              BorderRadius.circular(Dimensions.defaultRadius),
                          border: Border.all(
                              color: controller.withdrawMethod?.id.toString() ==
                                      '-1'
                                  ? MyColor.getFieldDisableBorderColor()
                                  : MyColor.getPrimaryColor(),
                              width: 0.5)),
                      child: DropdownButton<WithdrawMethod>(
                        ...
                        icon: Icon(Icons.keyboard_arrow_down,
                            color:
                                controller.withdrawMethod?.id.toString() == '-1'
                                    ? MyColor.getFieldDisableBorderColor()
                                    : MyColor.getPrimaryColor()),
                        iconDisabledColor: Colors.red,
                        iconEnabledColor: MyColor.getPrimaryColor(),
