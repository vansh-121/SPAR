          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  CardColumn(header:MyStrings.trx, body: trxData,textColor: MyColor.getPrimaryTextColor(),headerTextStyle: interRegularSmall.copyWith(color: MyColor.getPrimaryTextColor()),),
                  CardColumn(alignmentEnd:true,header:MyStrings.date, body: dateData,textColor: MyColor.getPrimaryTextColor(),headerTextStyle: interRegularSmall.copyWith(color: MyColor.getPrimaryTextColor())),
                ],
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  CardColumn(header:MyStrings.amount, body: amountData,textColor: MyColor.getPrimaryTextColor(),headerTextStyle: interRegularSmall.copyWith(color: MyColor.getPrimaryTextColor())),
                  CardColumn(alignmentEnd:true,header:MyStrings.postBalance, body: postBalanceData,textColor: MyColor.getPrimaryTextColor(),headerTextStyle: interRegularSmall.copyWith(color: MyColor.getPrimaryTextColor())),
                ],
              ),
