    ...
    return SafeArea(
      child: GetBuilder<TransactionController>(
        builder: (controller) => Scaffold(
            ...
            appBar: AppBar(
              title: Text(MyStrings.transactionHistory.tr,
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: MyColor.colorGrey.withOpacity(0.1)),
                      child: Image.asset(MyImages.filter,
                          color: controller.isFilter
                              ? MyColor.getPrimaryColor()
                              : MyColor.getSelectedIconColor(),
                          height: 15,
                          width: 15),
                    ),
                  ),
                                                  ...
                                                  dateData: DateConverter
                                                      .isoStringToLocalDateOnly(
                                                          controller
                                                              ...
                                                              ""),
                                                  amountData:
                                                      "${controller.transactionList[index].trxType} ${Converter.twoDecimalPlaceFixedWithoutRounding(controller.transactionList[index].amount.toString())} ${controller.currency}",
                                                  postBalanceData:
                                                      "${Converter.twoDecimalPlaceFixedWithoutRounding(controller.transactionList[index].postBalance.toString())} ${controller.currency}"),
                                            );
                                          },
                                        ),
                                      ))
