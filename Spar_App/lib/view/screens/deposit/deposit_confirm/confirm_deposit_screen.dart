...
import 'package:hyip_lab/data/controller/deposit_controller/deposit_confirm_controller.dart';
...
import 'package:hyip_lab/view/components/autofill_suggestion_banner.dart';
...
class ConfirmDepositScreen extends StatefulWidget {
  const ConfirmDepositScreen({Key? key,required this.model}) : super(key: key);
  final DepositInsertResponseModel model;
...
class _ConfirmDepositScreenState extends State<ConfirmDepositScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(DepositConfirmController(profileRepo:Get.find(),repo: Get.find()));
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DepositConfirmController>(
      builder: (controller) =>
          Scaffold(
            backgroundColor: MyColor.getScreenBgColor(),
            appBar: CustomAppBar(
              title: '${MyStrings.depositVia.tr} ${gatewayName.tr}',
            ),
            body: Stack(
              children: [
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (controller.showAutofillSuggestion && controller.lastTransactionData != null)
                            AutofillSuggestionBanner(
                              displaySummary: controller.lastTransactionData!.displaySummary ?? 'Previous details available',
                              onApply: () {
                                controller.applyAutofill();
                              },
                              onDismiss: () {
                                controller.dismissAutofillSuggestion();
                              },
                            ),
                          // Display deposit instruction if available
                          if (controller.depositInstruction != null && controller.depositInstruction!.isNotEmpty)
                            Container(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        MyStrings.depositInstruction.tr,
                                        style: TextStyle(
                          ...
                          Center(
                            child: RoundedButton(
                              ...
                              press: () {
                                controller.submitConfirmDepositRequest();
                              },
